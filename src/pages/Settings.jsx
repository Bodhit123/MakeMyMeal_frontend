...
const Settings = () => {
  ...
  useEffect(() => {
        ...
        { 
          ...
          render: function(data) {
            if (data.from !== data.to) {
              return moment(data.from).format("DD/MM/YYYY, dddd") + " - " + moment(data.to).format("DD/MM/YYYY, dddd");
            } else {
    ...
    $('#bookingTable tbody').on('click', '.update-btn', function() {
      const id = $(this).data('id');
    ...
    return () => {
      ...
      $('#bookingTable tbody').off('click', '.delete-btn');
      $('#bookingTable tbody').off('click', '.update-btn');
    ...
    <div>
      ...
      <div className="container-fluid">
        <div className="container pt-30 mb-1">
          ...
          >{`Total counts: ${disabledList.length}`}</h5>
          <section className="container-fluid mt-3">
            <table id="bookingTable" className="table table-responsive dataTable nowrap table-hover">
              <thead className="bg-light">
                <tr>
                  <th>Date</th>
                  <th>Reason</th>
